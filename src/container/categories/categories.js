                    ...
                    <div className="container-fluid">
                        <div className="container">
                            ...
                            <div className="C-title-right">
                                ...
                                <p>
                                    تیم طراحان ویشار در زمینه ها و دسته بندی های مختلف قادر به طراحی و تحویل سفارش می
                                    باشند. دسته بندی های مختلف ما، طیف گسترده ای از نیازهای طراحی شما را برآورده خواهد
                                    کرد. برخی از این دسته بندی ها شامل طراحی لوگو، بنر، کارت ویزیت، بروشور و... می باشد.
                                    جهت اطلاع از تمامی دسته بندی ها می توانید به صفحه دسته بندی سایت مراجعه فرمایید.
                                </p>
                            </div>
                        </div>
                    </div>
