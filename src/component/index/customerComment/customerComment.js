                        ...
                        <div>
                            ...
                            <Slider {...settings}>
                                ...
                                <div className="customer-box" >
                                    ...
                                    <p className="customer-text">
                                   بیشت از 5 سال است که در زمینه طراحی رابط کاربری و تجربه کاربری فعالیت دارم ، ویشار به راحتی پاسخگوی نیازهای من بوده و با اطمینان می توانم مشتریان خود را بیابم
